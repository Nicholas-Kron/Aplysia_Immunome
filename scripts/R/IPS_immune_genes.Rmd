...
read.delim("../../data/ROCO_TIR_data.txt", stringsAsFactors = FALSE, strip.white = TRUE, header = TRUE) %>%
  mutate(Protein_accession = factor(Protein_accession, levels = c("XP_005109462.3",
                                                                  "XP_035826698.1",
                                                                  "XP_012939950.2",
                                                                  "XP_012936376.2"
                                                                  ))) %>%
  ...
  geom_text(aes(x = -1, y = Protein_accession , label = "1"), size = 2.25, nudge_x = -15) +
  geom_text(aes(x = Seq_length, y = Protein_accession, label = Seq_length), size = 2.25, nudge_x = 50) +
  theme(axis.title = element_blank(), axis.ticks = element_blank(),
        axis.text.x = element_blank(), legend.position="bottom",
        legend.title = element_blank(), panel.grid = element_blank(),
        panel.background = element_blank(), text = element_text(face = "bold", color = "black")
