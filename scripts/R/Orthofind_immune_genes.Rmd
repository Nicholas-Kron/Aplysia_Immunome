...
Zhang_genes <- read.delim("../../data/immune_categoreis/Zhang_et_al_2015_Supplementary_Table_1A_Genes.txt", header = TRUE, strip.white = TRUE, stringsAsFactors = FALSE, na.strings = c("")) %>%
  rename("Cgig_gene" = Gene_ID) %>%
  fill(., Category, Group, Type, Subtype, .direction = "down")
Zhang_TLRS <- read.delim("../../data/immune_categoreis/Zhang_et_al_2015_Supplementary_Table_1B_TLRs.txt", header = TRUE, strip.white = TRUE, stringsAsFactors = FALSE, na.strings = c("")) %>%
